...
const [nav, inventory] = await parallel([
  ...
  () => agent([
    ...
    'revision history, not a roster - email-reminders-8b2caa99.md and',
    'delegate-configuration-8b2bd26d.md, each 91 CELL-OPENERS = about 29 dated revision entries.',
    'Census them, classify them as HISTORY, and do not',
    'mistake either for a missed catalogue. The real rosters are the three files named above.',
    'ONE CATALOGUE IS A GENUINE PRIZE: email-message-replacement-tokens-c9cc4af4.md - 21 CELL-OPENERS',
    'on the correct anchor, which is FOUR tokens (%1% %2% %3% %4%), NOT 21 of anything. The graph is',
    'ALREADY ASKING FOR IT - a Group 3 value set sits',
